...
<head>
	...
	<!-- Bootstrap -->
	<link type="text/css" rel="stylesheet" href="<?=base_url('/VAP/public/Main/')?>css/bootstrap.min.css" />

	<!-- Slick -->
	<link type="text/css" rel="stylesheet" href="<?=base_url('/VAP/public/Main/')?>css/slick.css" />
